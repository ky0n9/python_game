...
#메인화면
def StartScreen():
    Display.blit(pygame.font.Font("Typo_DabangguB.ttf",40).render("행 맨",True,BLACK), (210,20))
...
def main():
    ...
    Display.blit(pygame.font.Font("Typo_DabangguB.ttf",15).render("게임을 종료하려면 0을 누르세요.",True,BLACK),(20,10))
